...
" Uasge:
"   Line mode
"     <C-g><C-h>   Highlight current line 
"     <C-g><C-a>   Advance color for next line highlight
"     <C-g><C-r>   Clear last line highlight
"
"   Pattern mode
"     <C-g><C-w>   Highlight word under cursor (whole word match)
"     <C-g><C-l>   Highlight all lines having word under cursor (whole word match)
"     <C-g><C-f>   Highlight word under cursor (partial word match)
"     <C-g><C-k>   Highlight all lines having word under cursor (partial word match)
"     <C-g><C-s>   Highlight last search pattern
"     <C-g><C-j>   Highlight all lines having last search pattern
"     <C-g><C-d>   Clear last pattern highlight
"
"     <C-g><C-n>   Clear all highlights
"
"   All above commands work in both normal & insert modes.
"   <C-g><C-h> also works in visual mode. (Select desired lines & hit <C-h><C-h>)
"
" Installation:
...
noremap  <silent> <C-g><C-g> :call <SID>Highlight("h") \| nohls<CR>
" Advance color for next line highlight
noremap  <silent> <C-g><C-a> :call <SID>Highlight("a")<CR>
" Clear last line highlight
noremap  <silent> <C-g><C-r> :call <SID>Highlight("r")<CR>

" Highlight word under cursor (whole word match)
noremap  <silent> <C-g><C-w> :call <SID>Highlight("w") \| nohls<CR>
" Highlight all lines having word under cursor (whole word match)
noremap  <silent> <C-g><C-l> :call <SID>Highlight("l") \| nohls<CR>
" Highlight word under cursor (partial word match)
noremap  <silent> <C-g><C-f> :call <SID>Highlight("f") \| nohls<CR>
" Highlight all lines having word under cursor (partial word match)
noremap  <silent> <C-g><C-k> :call <SID>Highlight("k") \| nohls<CR>
" Highlight last search pattern
noremap  <silent> <C-g><C-s> :call <SID>Highlight("s") \| nohls<CR>
" Highlight all lines having last search pattern
noremap  <silent> <C-g><C-j> :call <SID>Highlight("j") \| nohls<CR>
" Clear last pattern highlight
noremap  <silent> <C-g><C-d> :call <SID>Highlight("d")<CR>

" Clear all highlights
noremap  <silent> <C-g><C-n> :call <SID>Highlight("n")<CR>


" -- Insert mode mappings --

" Highlight current line 
inoremap <silent> <C-g><C-g> <C-o>:call <SID>Highlight("h")<CR>
" Advance color for next line highlight
inoremap <silent> <C-g><C-a> <C-o>:call <SID>Highlight("a")<CR>
" Clear last line highlight
inoremap <silent> <C-g><C-r> <C-o>:call <SID>Highlight("r")<CR>

" Highlight word under cursor (whole word match)
inoremap <silent> <C-g><C-w> <C-o>:call <SID>Highlight("w") \| nohls<CR>
" Highlight all lines having word under cursor (whole word match)
inoremap <silent> <C-g><C-l> <C-o>:call <SID>Highlight("l") \| nohls<CR>
" Highlight word under cursor (partial word match)
inoremap <silent> <C-g><C-f> <C-o>:call <SID>Highlight("f") \| nohls<CR>
" Highlight all lines having word under cursor (partial word match)
inoremap <silent> <C-g><C-k> <C-o>:call <SID>Highlight("k") \| nohls<CR>
" Highlight last search pattern
inoremap <silent> <C-g><C-s> <C-o>:call <SID>Highlight("s") \| nohls<CR>
" Highlight all lines having last search pattern
inoremap <silent> <C-g><C-j> <C-o>:call <SID>Highlight("j") \| nohls<CR>
" Clear last pattern highlight
inoremap <silent> <C-g><C-d> <C-o>:call <SID>Highlight("d")<CR>

" Clear all highlights
inoremap <silent> <C-g><C-n> <C-o>:call <SID>Highlight("n")<CR>
